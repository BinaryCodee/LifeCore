...
public class LifeCoreAdminCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("reload")) {
            if (!sender.hasPermission(plugin.getConfigManager().getCommandPermission("lifecoreadmin_reload"))) {
                sender.sendMessage(plugin.getConfigManager().getMessage("no_permission"));
                return true;
            }
    ...
    private void sendHelpMessage(CommandSender sender) {
        ...
        sender.sendMessage(plugin.getConfigManager().getMessage("admin_help_setspawn"));
        sender.sendMessage(plugin.getConfigManager().getMessage("admin_help_reload"));
